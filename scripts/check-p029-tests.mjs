...
export async function scanP029Sources(input) {
  ...
  const required = [
    ...
    ['required justification', input.types, 'P029_JUSTIFICATION_REQUIRED'],
    ['web editor', input.page, 'MonthlyPlanningPage'],
    ['required justification field', input.page, 'id="planning-justification"'],
    ['justification before save', input.page, '!justification.trim()'],
    ['BigInt precision', input.webTypes, 'BigInt'],
    ['multi-entry builder', input.webTypes, 'buildPlanningEntries'],
